...
},{"./Entity":2,"./utils":9}],4:[function(require,module,exports){
"use strict";
  ...
  _createClass(PartRegistry, {
    ...
    registerPartTypeMesh: {
      ...
      */
      ...
      value: function registerPartTypeMesh(part, mesh, options) {
...
},{"./Part":3,"./utils":9}],5:[function(require,module,exports){
"use strict";
...
},{"../Assembly":1,"../utils":9}],7:[function(require,module,exports){
"use strict";
...
var Kernel = (function () {
  ...
  _createClass(Kernel, {
    ...
    loadDesign: {
      ...
      value: function loadDesign(uri, options, callback) {
        ...
        if (meshNameToPartTypeUId) {
          ...
          var finalData = {};
          //FIXME :weird json parse issues??
          for (var key in meshNameToPartTypeUId) {
            var nKey = "" + key;
            finalData[nKey] = meshNameToPartTypeUId[key];
          }
          this.partRegistry._meshNameToPartTypeUId = finalData;
        }
    ...
    loadActiveAssemblyState: {
      value: function loadActiveAssemblyState() {
        //local storage
    ...
    uploadDoc: {
      ...
      value: function uploadDoc(data, fileName, mimeType, uri) {
...
},{"./Assembly":1,"./Part":3,"./PartRegistry":4,"./bom/Bom":5,"./design/Design":6,"./testApi/testApi":8}],8:[function(require,module,exports){
"use strict";
...
var TestApi = (function () {
  function TestApi() {
    ...
    var testUri = "http://localhost:3080/api/designs/";
  }
