...
},{"./Entity":4,"./utils":13}],6:[function(require,module,exports){
"use strict";
...
},{"./Part":5,"./utils":13,"q":"q"}],7:[function(require,module,exports){
"use strict";
...
var Annotation = (function (_Entity) {
  function Annotation(options) {
    ...
    var options = Object.assign({}, DEFAULTS, options);
    _get(Object.getPrototypeOf(Annotation.prototype), "constructor", this).call(this, options);
    Object.assign(this, options);
  }

  _inherits(Annotation, _Entity);

  _createClass(Annotation, {
    clone: {
      value: function clone() {
        var clone = new Annotation({ name: this.name, title: this.title, notes: this.notes, color: this.color });
        return clone;
      }
    }
  });
...
},{"../Entity":4,"../utils":13}],8:[function(require,module,exports){
"use strict";
...
var ThicknessAnnotation = (function (_Annotation) {
  function ThicknessAnnotation(options) {
    _classCallCheck(this, ThicknessAnnotation);
    ...
    var options = Object.assign({}, DEFAULTS, options);
    _get(Object.getPrototypeOf(ThicknessAnnotation.prototype), "constructor", this).call(this, options);
    Object.assign(this, options);
  ...
  _inherits(ThicknessAnnotation, _Annotation);

  _createClass(ThicknessAnnotation, {
    clone: {
      value: function clone() {
        var clone = new ThicknessAnnotation({
  ...
  return ThicknessAnnotation;
})(Annotation);

ThicknessAnnotation.prototype.typeUid = generateUUID();

exports.ThicknessAnnotation = ThicknessAnnotation;

},{"../utils":13,"./Annotation":7}],9:[function(require,module,exports){
"use strict";
...
var Bom = (function () {
  ...
  _createClass(Bom, {
    ...
    getEntryInstances: {
      ...
      value: function getEntryInstances(entry) {
        this.bom[entry];
        return;
      }
    },
    ...
    lookUpInstanceRefs: {
      ...
      value: function lookUpInstanceRefs(bomEntriesIdx, bomEntryInstancesIdx, bom) {
...
},{"../Assembly":3,"../utils":13,"nid":2}],11:[function(require,module,exports){
"use strict";
...
var ThicknessAnnotation = require("./annotations/ThicknessAnnot.js").ThicknessAnnotation;
...
var Kernel = (function () {
  ...
  _createClass(Kernel, {
    ...
    registerVisualTypeForEntityType: {
      ...
      */
      ...
      value: function registerVisualTypeForEntityType(mesh, entity, templateParams) {}
    },
    ...
    getMeshOfEntity: {
      ...
      value: function getMeshOfEntity(entity) {
        if (!entity || !this.entitiesToMeshInstancesMap.has(entity)) {
          return undefined;
...
},{"./Assembly":3,"./Part":5,"./PartRegistry":6,"./annotations/ThicknessAnnot.js":8,"./bom/Bom":9,"./design/Design":10,"./testApi/testApi":12,"./utils":13,"co":1}],12:[function(require,module,exports){
"use strict";
